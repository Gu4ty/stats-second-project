...
# muy poca. Es conocido en la literatura que cluster jerarquico no
# escala bien. Aunque no se pudo aplicar esta tecnica intuimo que
# no aportaria mucha informacion, pues al ser una gran cantidad de
# individuos identificar que significa cada cluster tomaria una
# enorme e innecesaria cantidad de tiempo.
