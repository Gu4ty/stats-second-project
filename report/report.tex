...
Ejecutando el c\'odigo correspondiente a esta secci\'on se pude obtener la imagen, o visualizar directamente en la carpeta "src/reduction\_techniques/images" el archivo "elbow.png". Tambi\'en se puede ver "kproto.png" para ver los cl\'usters en los datos.
...
Las t\'ecnicas estudiadas en clases se enfoca principalmente en valores cualitativos y nuestro datos son en su mayori\'ia cualitativo, eso requiri\'o un aumento de dimensi\'on en los datos para convertirlos en cuantitativos resultando en complicaciones adicionales. 

Adem\'as el an\'alisis de los datos muestra que est\'an poco correlacionados y sesgados. Las t\'ecnicas de car\'acter l\'ineal surten poco efecto y los supuestos no se cumplen. Regresi\'on l\'ineal, PCA y ANOVA no fueron efectivas.

El algoritmo CART obtuvo buenas puntuaciones prediciendo cuando alguien ganaba menos de 50k pero se equivocaba la mitad de las veces para predecir lo contrario.

Con kprototype, le extensi\'on de kmeans, se pudo obtener una mejor visualizaci\'on de los datos y como est\'an compuestos. Esto permiti\'o intuir cuales son las variables principales que influyen sobre el conjunto.

\section*{Contribuciones de cada integrante}

 Para la realizaci\'on del proyecto se sigui\'o la siguiente estrategia:

 Cada integrante escogi\'o un tipo de t\'ecina para aplicar ( reducción de dimensión, regresión lineal o ANOVA ). Luego
 ...
 Siguiendo esta estrategia las tareas se dividieron de la siguiente forma: Adri\'an Rodr\'iguez Portales regresión lineal, David Guaty ANOVA y Rodrigo Pino reducción de dimensión.
